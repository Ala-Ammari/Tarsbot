...
(cl:defmethod cl:initialize-instance :after ((m <Encoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarsbot_msgs-msg:<Encoders> is deprecated: use tarsbot_msgs-msg:Encoders instead.")))

(cl:ensure-generic-function 'ticks-val :lambda-list '(m))
(cl:defmethod ticks-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:ticks-val is deprecated.  Use tarsbot_msgs-msg:ticks instead.")
  (ticks m))
