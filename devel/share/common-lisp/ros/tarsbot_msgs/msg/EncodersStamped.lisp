...
(cl:defclass <EncodersStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (encoders
    :reader encoders
    :initarg :encoders
    :type tarsbot_msgs-msg:Encoders
    :initform (cl:make-instance 'tarsbot_msgs-msg:Encoders)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EncodersStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EncodersStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarsbot_msgs-msg:<EncodersStamped> is deprecated: use tarsbot_msgs-msg:EncodersStamped instead.")))
...
(cl:defmethod encoders-val ((m <EncodersStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:encoders-val is deprecated.  Use tarsbot_msgs-msg:encoders instead.")
  (encoders m))
