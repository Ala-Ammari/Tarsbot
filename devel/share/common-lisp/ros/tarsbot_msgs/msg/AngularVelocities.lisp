...
(cl:defmethod cl:initialize-instance :after ((m <AngularVelocities>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AngularVelocities)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarsbot_msgs-msg:<AngularVelocities> is deprecated: use tarsbot_msgs-msg:AngularVelocities instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <AngularVelocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:joint-val is deprecated.  Use tarsbot_msgs-msg:joint instead.")
  (joint m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AngularVelocities>)))
  ...
  "tarsbot_msgs/AngularVelocities")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AngularVelocities)))
  "Returns string type for a message object of type 'AngularVelocities"
  "tarsbot_msgs/AngularVelocities")
