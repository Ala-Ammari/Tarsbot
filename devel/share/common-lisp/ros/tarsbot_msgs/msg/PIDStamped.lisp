...
(cl:defclass <PIDStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (pid
    :reader pid
    :initarg :pid
    :type tarsbot_msgs-msg:PID
    :initform (cl:make-instance 'tarsbot_msgs-msg:PID)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PIDStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PIDStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarsbot_msgs-msg:<PIDStamped> is deprecated: use tarsbot_msgs-msg:PIDStamped instead.")))
...
(cl:defmethod pid-val ((m <PIDStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:pid-val is deprecated.  Use tarsbot_msgs-msg:pid instead.")
  (pid m))
