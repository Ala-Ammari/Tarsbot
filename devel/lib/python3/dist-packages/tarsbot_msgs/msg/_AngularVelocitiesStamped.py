...
"""autogenerated by genpy from tarsbot_msgs/AngularVelocitiesStamped.msg. Do not edit."""
import codecs
import sys
...
class AngularVelocitiesStamped(genpy.Message):
  _md5sum = "62b2cae704bd641c35dea902c2913994"
  _type = "tarsbot_msgs/AngularVelocitiesStamped"
...
# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.
float32[] joint"""
  __slots__ = ['header','angular_velocities']
  _slot_types = ['std_msgs/Header','tarsbot_msgs/AngularVelocities']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AngularVelocitiesStamped, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.angular_velocities is None:
        self.angular_velocities = tarsbot_msgs.msg.AngularVelocities()
    else:
      self.header = std_msgs.msg.Header()
      self.angular_velocities = tarsbot_msgs.msg.AngularVelocities()
