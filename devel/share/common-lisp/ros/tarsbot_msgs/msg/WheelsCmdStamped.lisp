...
(cl:in-package tarsbot_msgs-msg)
...
(cl:defclass <WheelsCmdStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (wheels_cmd
    :reader wheels_cmd
    :initarg :wheels_cmd
    :type tarsbot_msgs-msg:WheelsCmd
    :initform (cl:make-instance 'tarsbot_msgs-msg:WheelsCmd)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WheelsCmdStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelsCmdStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tarsbot_msgs-msg:<WheelsCmdStamped> is deprecated: use tarsbot_msgs-msg:WheelsCmdStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:header-val is deprecated.  Use tarsbot_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'wheels_cmd-val :lambda-list '(m))
(cl:defmethod wheels_cmd-val ((m <WheelsCmdStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tarsbot_msgs-msg:wheels_cmd-val is deprecated.  Use tarsbot_msgs-msg:wheels_cmd instead.")
  (wheels_cmd m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WheelsCmdStamped>)))
  ...
  (cl:format cl:nil "# This is a message that holds commanded angular joint velocity~%Header header~%~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%WheelsCmd wheels_cmd~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: tarsbot_msgs/WheelsCmd~%# This is a message that holds commanded angular joint velocity~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%AngularVelocities angular_velocities~%================================================================================~%MSG: tarsbot_msgs/AngularVelocities~%# This is a message that holds commanded angular joint velocity~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%float32[] joint~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WheelsCmdStamped)))
  "Returns full string definition for message of type 'WheelsCmdStamped"
  (cl:format cl:nil "# This is a message that holds commanded angular joint velocity~%Header header~%~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%WheelsCmd wheels_cmd~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: tarsbot_msgs/WheelsCmd~%# This is a message that holds commanded angular joint velocity~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%AngularVelocities angular_velocities~%================================================================================~%MSG: tarsbot_msgs/AngularVelocities~%# This is a message that holds commanded angular joint velocity~%# Use an array of type float32 for the two wheel joint velocities.~%# float32 is used instead of float64 because it is not supporte by Arduino/Teensy.~%float32[] joint~%~%"))
